...
<div class="flex space-x-3">
  <Icon href="https://github.com/{publicVariables.githubProfile}">
    <svg
      ...
      class="stroke-white fill-transparent w-5 h-5 feather feather-github"
    >
      <path
  ...
  <Icon href="https://linkedin.com/in/{publicVariables.linkedinProfile}">
    <svg
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      class="stroke-white w-5 h-5 feather feather-linkedin"
      ><path
  ...
  <!-- <Icon href="https://twitter.com/{publicVariables.twitterProfile}">
		<svg
			...
			stroke-linecap="round"
			stroke-linejoin="round"
			class="stroke-white w-5 h-5 feather feather-twitter"
			><path
