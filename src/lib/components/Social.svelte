...
<div class="flex space-x-3">
  <Icon href="https://github.com/{publicVariables.githubProfile}">
    <svg
      ...
      class="stroke-accent fill-transparent w-5 h-5 feather feather-github"
    >
      <path
  ...
  <Icon href={publicVariables.huggingfaceProfile}><span class="text-lg no-underline">🤗</span></Icon
  >
  <Icon href="https://linkedin.com/in/{publicVariables.linkedinProfile}">
    <svg
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      class="stroke-accent w-5 h-5 feather feather-linkedin"
      ><path
        d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"
      /><rect x="2" y="9" width="4" height="12" /><circle cx="4" cy="4" r="2" /></svg
    >
  </Icon>
  <!-- <Icon href="https://twitter.com/{publicVariables.twitterProfile}">
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 24 24"
			stroke-width="1.5"
			stroke-linecap="round"
			stroke-linejoin="round"
			class="stroke-accent w-5 h-5 feather feather-twitter"
			><path
				d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"
			/></svg
		>
	</Icon> -->
  <Icon href={publicVariables.googleScholarProfile}>
    <svg
      fill="#000000"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      stroke-width="1"
      class="stroke-accent w-6 h-6"
      ><path
  ...
  <Icon href="mailto:{publicVariables.email}">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="none"
  ...
  <Icon href="/cv.pdf"
    ><span class="link link-hover text-lg text-accent no-underline">CV</span></Icon
  >
</div>
